...
SOCIALACCOUNT_PIPELINE = (
    ...
    'core.utils.save_google_profile_picture',  # <-- custom step
...
SERVER_EMAIL = "security@em1232.stepper.dpdns.org"
DEFAULT_REPLY_TO_EMAIL = "Reply -To security@em1232.stepper.dpdns.org"
